...
class TestSkillRegistry:
  ...
  def test_register_duplicate_skill_raises(self) -> None:
    ...
    registry = SkillRegistry()
    skill1 = Skill(simple_name="test", description="First", content="Content 1")
    skill2 = Skill(simple_name="test", description="Second", content="Content 2")
  ...
  def test_get_skill(self) -> None:
    """Get a skill by name."""
    registry = SkillRegistry()
    skill = Skill(simple_name="test", description="Test", content="Content")
  ...
  def test_names_property(self) -> None:
    ...
    registry = SkillRegistry()
    skill1 = Skill(simple_name="alpha", description="A", content="Content A")
    skill2 = Skill(simple_name="beta", description="B", content="Content B")
  ...
  def test_count_property(self) -> None:
    ...
    skill1 = Skill(simple_name="a", description="A", content="Content A")
    skill2 = Skill(simple_name="b", description="B", content="Content B")
