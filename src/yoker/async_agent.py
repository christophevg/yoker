...
This module provides AsyncAgent, an async-first agent that chats with Ollama
and uses tools. It follows the httpx pattern with separate Agent (sync) and
AsyncAgent (async) classes sharing identical public interfaces.
"""
