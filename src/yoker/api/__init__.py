...
Three layers, each building on the previous:
  ...
  - **Layer 1 — One-shot**: :func:`process` runs a single turn and returns
    the response string. The agent is discarded after the call.
  - **Layer 2 — Agent**: :func:`agent` returns a configured, reusable
    :class:`yoker.Agent`.
...
from yoker.api.one_shot import ThinkingLiteral, process
