...
Provides the ``make_existence_tool`` factory that returns a callable for
checking if files and folders exist. Guardrails are enforced centrally by
...
def make_existence_tool() -> Any:
  """Create the existence tool callable."""
